...
export const router = createBrowserRouter([
  ...
  { path: '/donate/:id', element: <ProtectedRoute><DonationAmount /></ProtectedRoute> },
  { path: '/donate/:id/payment', element: <ProtectedRoute><DonationPayment /></ProtectedRoute> },
  { path: '/donate/success', element: <ProtectedRoute><DonationSuccess /></ProtectedRoute> },
